...
with DAG(
    ...
    table = "user_session_db.analytics.session_summary"
    select_sql = """SELECT u.*, s.ts
    FROM user_session_db.raw_data.user_session_channel u
    JOIN user_session_db.raw_data.session_timestamp s ON u.sessionId=s.sessionId
    """
